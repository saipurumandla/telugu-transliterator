"""Generate DATASET_CARD.md with full provenance and license summary."""
...
def make_dataset_card(output: str = "DATASET_CARD.md") -> None:
    Path(output).write_text(CARD, encoding="utf-8")
    print(f"Dataset card written to {output}")
